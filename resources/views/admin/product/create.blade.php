                    ...
                    success: function(response) {
                        if (response.status == true) {
                            ...
                            window.location.href =
                                "{{ route('Product.index') }}?status=success&message=Product created successfully";
                            ...
                            if (error.title) {
                                $("#title").addClass('is-invalid').siblings('p').addClass(
                                    'invalid-feeback text text-danger').text(error.title)
                            } else {
                                $("#title").removeClass('is-invalid').siblings('p').removeClass(
                                    'invalid-feeback text text-danger').text('')
                            }
                            if (error.slug) {
                                $("#slug").addClass('is-invalid').siblings('p').addClass(
                                    'invalid-feeback text text-danger').text(error.slug)
                            } else {
                            ...
                            if (error.price) {
                                $("#price").addClass('is-invalid').siblings('p').addClass(
                                    'invalid-feeback text text-danger').text(error.price)
                            } else {
                            ...
                            if (error.sku) {
                                $("#sku").addClass('is-invalid').siblings('p').addClass(
                                    'invalid-feeback text text-danger').text(error.sku)
                            } else {
                            ...
                            if (error.qty) {
                                $("#qty").addClass('is-invalid').siblings('p').addClass(
                                    'invalid-feeback text text-danger').text(error.qty)
                            } else {
                            ...
                            if (error.category) {
                                $("#category").addClass('is-invalid').siblings('p').addClass(
                                    'invalid-feeback text text-danger').text(error.category)
                            } else {
                                $("#category").removeClass('is-invalid').siblings('p')
                                    .removeClass('invalid-feeback text text-danger').text('')
                            }
