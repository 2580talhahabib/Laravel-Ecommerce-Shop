	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
        			...
        			<!-- <li class="nav-item">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark">
                                ...
                                <li><a class="dropdown-item nav-link" href="{{ route('front.shop',[$category->slug,$subcategories->slug]) }}">{{ $subcategories->name }}</a></li>
                                @endforeach
			...
			<div class="right-nav py-0">
				<a href="{{ asset('front-asset/cart.php') }}" class="ml-3 d-flex pt-2">
			...
			<div class="col-md-4">
				<div class="footer-card">
					...
					<ul>
						...
						<li><a href="{{ asset('front-asset/contact-us.php') }}" title="Contact Us">Contact Us</a></li>
